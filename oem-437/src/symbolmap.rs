pub fn oem437_lookup_unicode_char(byte: u8) -> char {
    let u32_val = oem437_lookup_unicode(byte) as u32;
    //SAFETY: We explictly map numbers, so this should be safe.
...
pub fn oem437_lookup_unicode(byte: u8) -> u16 {
    match byte {
        0x00 => 0x0000,
        0x01 => 0x263A,
        0x02 => 0x263B,
